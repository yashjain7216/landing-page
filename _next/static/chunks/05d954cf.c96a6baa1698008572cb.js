    ...
    ZMKu: function(t, e, n) {
        ...
        var h = function(t) {
          ...
          , m = function(t) {
            ...
            return "string" === typeof t ? (Object(a.a)(void 0 !== v[t], "Invalid easing type '" + t + "'"),
            v[t]) : t
        }
          , g = function(t, e) {
        ...
        function w(t) {
            ...
            e ? u.repeatType = "reverse" : n ? u.repeatType = "loop" : i && (u.repeatType = "mirror"),
        ...
        function C(t, e, n) {
            ...
            function(t) {
                Array.isArray(t.to) && null === t.to[0] && (t.to = Object(r.e)(t.to),
                t.to[0] = t.from)
            }(e),
            function(t) {
                t.when,
        ...
        function S(t, e, n, i) {
            ...
            e.start((function(u) {
                var c, l, d = function(t, e, n, i, u) {
                    ...
                    }(i, t), d = null !== (c = l.from) && void 0 !== c ? c : e.get(), f = g(t, n);
                    "none" === d && f && "string" === typeof n && (d = s.c.getAnimatableNone(n));
                    var p = g(t, d);
                    return Object(a.b)(p === f, "You are trying to animate " + t + ' from "' + d + '" to "' + n + '". ' + d + " is not an animatable value - to enable this animation set " + d + " to a value animatable to " + n + " via the `style` property."),
                    p && f && !1 !== l.type ? function() {
                        var i = {
                            from: d,
                            to: n,
                        ...
                        return "inertia" === l.type || "decay" === l.type ? Object(o.r)(Object(r.a)(Object(r.a)({}, i), l)) : Object(o.a)(Object(r.a)(Object(r.a)({}, C(l, i, t)), {
                            onUpdate: function(t) {
                                var e;
                                i.onUpdate(t),
                                null === (e = l.onUpdate) || void 0 === e || e.call(l, t)
                            },
                            onComplete: function() {
                                var t;
                                i.onComplete(),
                                null === (t = l.onComplete) || void 0 === t || t.call(l)
                            }
                        }))
                    }
                    : function() {
                        ...
                        return e.set(n),
                        u(),
                        null === (t = null === l || void 0 === l ? void 0 : l.onComplete) || void 0 === t || t.call(l),
                        {
                            stop: function() {}
                        }
                    }
                }(t, e, n, i, u), f = function(t, e) {
                    var n, r, i, o, a;
        ...
        function Y(t, e, n) {
            var i = (void 0 === n ? {} : n).priority
              ...
              , s = void 0 === a ? {} : a
              , u = (o.transition,
            Object(r.d)(o, ["transitionEnd", "transition"]));
            ...
            if (c)
                for (var l = 0; l < c; l++) {
                    var d = u[l]
                      , f = e[d]
                      , h = null;
                    if (Array.isArray(f) && (h = f[0]),
                    null === h) {
                        var v = null !== (r = n[d]) && void 0 !== r ? r : t.readNativeValue(d);
                        h = void 0 !== v ? v : e[d],
                        Object(a.a)(null !== h, 'No initial value for "' + d + '" can be inferred. Ensure an initial value for "' + d + '" is defined on the component.')
                    }
                    "string" === typeof h && /^\-?\d*\.?\d+$/.test(h) ? h = parseFloat(h) : !R(h) && s.c.test(f) && (h = s.c.getAnimatableNone(f)),
                    t.addValue(d, p(h)),
                    null !== (i = (o = n)[d]) && void 0 !== i || (o[d] = h),
                    t.baseTarget[d] = h
                }
        }
        function W(t, e) {
        ...
        function G(t, e, n) {
            var r, i, o = {};
            for (var a in t)
                o[a] = null !== (r = W(a, e)) && void 0 !== r ? r : null === (i = n.getValue(a)) || void 0 === i ? void 0 : i.get();
            return o
        }
        function Z(t, e, n) {
            var i;
        ...
        function _(t, e, n) {
            var i, o = n && n.priority || 0, a = t.getVariant(e), s = I(t, a, n && n.custom), u = s.transition || {}, c = a ? function() {
                return $(t, s, n)
            }
            : function() {
        ...
        function $(t, e, n) {
            ...
            for (var g in v) {
                ...
                if (y && v && void 0 !== v[g]) {
                    ...
                    t.isAnimating.has(g) || (t.isAnimating.add(g),
                    m.push(S(g, y, b, Object(r.a)({
                        delay: a
                    }, h))))
                }
            }
        ...
        var tt = function() {
            function t(t, e) {
                ...
                this.ref = function(t) {
                    ...
                    n.externalRef && ("function" === typeof n.externalRef ? n.externalRef(t) : l(n.externalRef) && (n.externalRef.current = t))
                }
                ,
                this.parent = t,
            ...
            t.prototype.resetIsAnimating = function(t) {
                ...
                null === (e = this.variantChildren) || void 0 === e || e.forEach((function(e) {
            ...
            t.prototype.getValue = function(t, e) {
                ...
                return void 0 === n && void 0 !== e && (n = new f(e),
                this.addValue(t, n)),
                n
            }
            ,
            ...
            t.prototype.setStaticValues = function(t, e) {
                if ("string" === typeof t)
                    this.setSingleStaticValue(t, e);
                else
                    for (var n in t)
                        this.setSingleStaticValue(n, t[n])
            }
            ,
            ...
            t.prototype.mount = function(t) {
                Object(a.a)(!!t, "No ref found. Ensure components created with motion.custom forward refs using React.forwardRef"),
        ...
        function xt(t, e, n) {
            void 0 === n && (n = 1),
            Object(a.a)(n <= 4, 'Max CSS variable fallback depth detected in property "' + t + '". This may indicate a circular fallback dependency.');
          ...
          , Et = {
            ...
            boxShadow: {
                process: function(t, e, n, r) {
                    ...
                    "number" === typeof c[2 + d] && (c[2 + d] /= h),
                    "number" === typeof c[3 + d] && (c[3 + d] /= h);
                    var v = l(c);
                    if (a) {
                        var m = 0;
        ...
        function wt(t, e, n, r, i, o, a, s, u, c, l, d) {
            ...
            s ? (e.transform = vt(c, l),
            e.transform === mt && (e.transform = ""),
            v && (e.transform += " " + function(t, e) {
                var n = "";
                e.sort(ct);
            ...
            e.transformOrigin = function(t) {
                ...
                return !s && i ? a += "translateZ(0)" : a = a.trim(),
        ...
        function kt(t, e, n, r, i) {
            return t = St(t -= e, 1 / n, r),
            void 0 !== i && (t = St(t, 1 / i, r)),
            t
        }
        function Rt(t, e, n) {
            ...
            !function(t, e, n, r, i) {
                ...
                t.min = kt(t.min, e, n, a, i),
                t.max = kt(t.max, e, n, a, i)
        ...
        function Ut(t, e) {
            var n, r = .5, i = Dt(t), a = Dt(e);
            return a > i ? r = Object(o.w)(e.min, e.max - i, t.min) : i > a && (r = Object(o.w)(t.min, t.max - a, e.min)),
            n = r,
            Object(o.l)(0, 1, n)
        }
        function Ft(t, e, n, r) {
        ...
        var Xt, zt = new Set(["width", "height", "top", "left", "right", "bottom", "x", "y"]), Nt = function(t) {
            return zt.has(t)
        }, Wt = function(t, e) {
            t.set(e, !1),
            t.set(e)
        ...
        var Kt = {
          ...
          , Jt = function(t, e, n, i) {
            ...
            if (o.forEach((function(r) {
                var o = t.getValue(r);
                if (t.hasValue(r)) {
                    var d, f = n[r], p = e[r], h = L(f);
                    if (y(p))
                        for (var v = p.length, m = null === p[0] ? 1 : 0; m < v; m++)
                            d ? Object(a.a)(L(p[m]) === d, "All keyframes must be of the same type") : (d = L(p[m]),
                            Object(a.a)(d === h || Gt(h) && Gt(d), "Keyframes must be of the same dimension as the current value"));
                    else
                        d = L(p);
                    if (h !== d)
                        if (Gt(h) && Gt(d)) {
                            ...
                            "string" === typeof p ? e[r] = parseFloat(p) : Array.isArray(p) && d === s.j && (e[r] = p.map(parseFloat))
                        } else
                            (null === h || void 0 === h ? void 0 : h.transform) && (null === d || void 0 === d ? void 0 : d.transform) && (0 === f || 0 === p) ? 0 === f ? o.set(d.transform(f)) : e[r] = h.transform(p) : (c || (u = function(t) {
                                var e = [];
            ...
            l.length) {
                var d = function(t, e, n) {
                    ...
                    "none" === o && e.setStaticValues("display", t.display || "block"),
                    e.render();
        ...
        var te = function(t, e, n, i) {
            var o = function(t, e, n) {
                var i, o = Object(r.d)(e, []), a = t.getInstance();
          ...
          , ee = function(t) {
            function e() {
                ...
                e.layoutUpdateListeners = new d,
                e.layoutMeasureListeners = new d,
                e.viewportBoxUpdateListeners = new d,
            ...
            e.prototype.updateConfig = function(t) {
                void 0 === t && (t = {}),
                this.config = Object(r.a)(Object(r.a)({}, this.defaultConfig), t)
            }
            ,
            ...
            e.prototype.hide = function() {
                !1 !== this.isVisible && (this.isVisible = !1,
                this.scheduleRender())
            }
            ,
            ...
            e.prototype.startLayoutAxisAnimation = function(t, e) {
                var n, r = this, i = this.axisProgress[t], o = this.targetBox[t], a = o.min, s = o.max - a;
            ...
            e.prototype.updateLayoutDeltas = function() {
                ...
                Ct(t.x, e.x),
                Ct(t.y, e.y),
                this.parent && (this.prevTreeScale.x = this.treeScale.x,
                ...
                It(this.delta, this.boxCorrected, this.targetBox, this.layoutOrigin),
                ...
                o === this.deltaTransform && this.prevTreeScale.x === this.treeScale.x && this.prevTreeScale.y === this.treeScale.y || this.scheduleRender(),
                this.deltaTransform = o
            }
            ,
            e.prototype.updateTransformDeltas = function() {
                var t, e, n;
                this.isLayoutProjectionEnabled && this.box && (t = this.targetBoxFinal,
                e = this.targetBox,
                n = this.latest,
                Vt(t.x, e.x, n, Bt),
                Vt(t.y, e.y, n, Lt),
                It(this.deltaFinal, this.boxCorrected, this.targetBoxFinal, this.layoutOrigin))
            }
            ,
            e.prototype.build = function() {
                this.updateTransformDeltas(),
                void 0 !== this.isVisible && (this.style.visibility = this.isVisible ? "visible" : "hidden"),
                wt(this.latest, this.style, this.vars, this.transform, this.transformOrigin, this.transformKeys, this.config, this.isLayoutProjectionEnabled && !!this.box, this.delta, this.deltaFinal, this.treeScale, this.targetBoxFinal)
            }
            ,
        ...
        function ce(t, e, n, i, o, a, s, u, c, l, d, f, p, h, v) {
            var m = t.attrX
              ...
              , E = t.pathOffset
              , w = void 0 === E ? 0 : E;
            return wt(Object(r.d)(t, ["attrX", "attrY", "originX", "originY", "pathLength", "pathSpacing", "pathOffset"]), i, n, o, a, s, u, d, f, p, h, v),
            i.transform && (e.transform = i.transform,
            delete i.transform),
            (void 0 !== y || void 0 !== b || e.transform) && (e.transformOrigin = function(t, e, n) {
                return ie(e, t.x, t.width) + " " + ie(n, t.y, t.height)
            }(c || ue, void 0 !== y ? y : .5, void 0 !== b ? b : .5)),
            void 0 !== m && (i.x = m),
            void 0 !== g && (i.y = g),
            void 0 !== l && void 0 !== x && function(t, e, n, r, i, o) {
                void 0 === r && (r = 1),
                void 0 === i && (i = 0),
                void 0 === o && (o = !0);
                var a = o ? ae : se;
        ...
        var le = new Set(["baseFrequency", "diffuseConstant", "kernelMatrix", "kernelUnitLength", "keySplines", "keyTimes", "limitingConeAngle", "markerHeight", "markerWidth", "numOctaves", "targetX", "targetY", "surfaceScale", "specularConstant", "specularExponent", "stdDeviation", "tableValues", "viewBox"])
          ...
          , pe = function(t) {
            ...
            ,
            e.prototype.read = function(t) {
                return t = le.has(t) ? t : fe(t),
                this.element.getAttribute(t)
            }
            ,
            e.prototype.build = function() {
                this.updateTransformDeltas(),
                ce(this.latest, this.style, this.vars, this.attrs, this.transform, this.transformOrigin, this.transformKeys, this.config, this.dimensions, this.totalPathLength, this.isLayoutProjectionEnabled && !!this.box, this.delta, this.deltaFinal, this.treeScale, this.targetBoxFinal)
            }
            ,
            e.prototype.render = function() {
                for (var e in t.prototype.render.call(this),
                this.attrs)
                    this.element.setAttribute(le.has(e) ? e : fe(e), this.attrs[e])
            }
            ,
            e
        }(ee);
        ...
        function Se(t, e, n, r, i) {
            for (var o in void 0 === r && (r = !1),
            r && (t.reactStyle = {}),
            n) {
                var a = n[o]
                  , s = !1;
                if (we(a))
                    Te.has(o) || (t.addValue(o, a),
                    s = !0);
                else if (Ce(o, i)) {
                    if (t.hasValue(o)) {
                        if (a !== e[o]) {
        ...
        var Pe, Ae, Te = new Set([]), Ve = function() {
            return {}
        ...
        function Ze(t, e) {
            ...
            return Object(u.forwardRef)((function(e, a) {
                ...
                var l = function(t, e, n) {
                    var r, i, o = e.variants, a = e.initial, s = e.animate, c = e.whileTap, l = e.whileHover, d = ye(), f = d.parent, p = d.initial, h = d.animate, v = Object(u.useContext)(me), m = We(s) || We(c) || We(l) || Ge(s), g = o || m;
                    !1 !== (a = null !== (r = null === v || void 0 === v ? void 0 : v.initial) && void 0 !== r ? r : a) || Ge(s) || (a = s);
                    ...
                    g && !m && (null === f || void 0 === f || f.addVariantChild(t)),
                    He(v) && (null === (i = t.variantChildrenOrder) || void 0 === i || i.clear()),
                    Object(u.useEffect)((function() {
                    ...
                    Object(u.useEffect)((function() {
                        ...
                        function() {
                            var e;
                            t.isMounted = !1,
                            null === (e = null === f || void 0 === f ? void 0 : f.variantChildren) || void 0 === e || e.delete(t)
                        }
                    }
                    ), []),
                    Ne((function() {
                ...
                Object(u.createElement)(u.Fragment, null, Object(u.createElement)(ge.Provider, {
                    value: f
                }, p), d)
            }
            ))
        ...
        function dn(t) {
            return un && null === window.onpointerdown ? t : un && null === window.ontouchstart ? ln[t] : un && null === window.onmousedown ? cn[t] : t
        }
        function fn(t, e, n, r) {
            return Je(t, dn(e), sn(n, "pointerdown" === e), r)
        }
        function pn(t, e, n, r) {
        ...
        var hn = function() {
            function t(t, e, n) {
                    ...
                    if (a.lastMoveEvent && a.lastMoveEventInfo) {
                        ...
                        if (e || n) {
                            ...
                            var c = a.handlers
                              , l = c.onStart
                              , d = c.onMove;
                            e || (l && l(a.lastMoveEvent, t),
                            a.startEvent = a.lastMoveEvent),
                            d && d(a.lastMoveEvent, t)
                        }
                    }
                }
                ,
                this.handlePointerMove = function(t, e) {
                    ...
                    Qe(t) && 0 === t.buttons ? a.handlePointerUp(t, e) : i.b.update(a.updatePoint, !0)
                }
                ,
                ...
                !(tn(t) && t.touches.length > 1)) {
                    ...
                    d && d(t, gn(u, this.history)),
                    this.removeListeners = Object(o.v)(fn(window, "pointermove", this.handlePointerMove), fn(window, "pointerup", this.handlePointerUp), fn(window, "pointercancel", this.handlePointerUp))
                }
            }
        ...
        function xn(t, e) {
            ...
            for (var n = t.length - 1, r = null, i = bn(t); n >= 0 && (r = t[n],
            !(i.timestamp - r.timestamp > h(e))); )
                n--;
            if (!r)
                return {
                    x: 0,
        ...
        function jn(t, e, n) {
            var r = e.min
              , i = e.max;
            return void 0 !== r && t < r ? t = n ? Object(o.u)(r, t, n) : Math.max(t, r) : void 0 !== i && t > i && (t = n ? Object(o.u)(i, t, n) : Math.min(t, i)),
            t
        }
        function On(t, e, n) {
            return {
        ...
        function En(t, e) {
            var n, i = e.min - t.min, o = e.max - t.max;
            return e.max - e.min < t.max - t.min && (i = (n = Object(r.c)([o, i], 2))[0],
            o = n[1]),
            {
                min: t.min + i,
                max: t.min + o
        ...
        var wn, Cn = new WeakMap, Sn = function() {
            function t(t) {
            ...
            return t.prototype.start = function(t, e) {
                ...
                this.panSession = new hn(t,{
                    onSessionStart: function() {
                        n.stopMotion()
                    },
                    onStart: function(t, e) {
                        var r, i, a = n.props, u = a.drag, c = a.dragPropagation;
                        if (!u || c || (n.openGlobalLock && n.openGlobalLock(),
                    ...
                    onMove: function(t, e) {
                        var r, i, o, a, s = n.props, u = s.dragPropagation, c = s.dragDirectionLock;
                        if (u || n.openGlobalLock) {
                            ...
                            if (c && null === n.currentDirection)
                                ...
                                void (null !== n.currentDirection && (null === (i = (r = n.props).onDirectionLock) || void 0 === i || i.call(r, n.currentDirection)));
                            n.updateAxis("x", t, l),
                            n.updateAxis("y", t, l),
            ...
            t.prototype.prepareBoundingBox = function() {
                ...
                t.style.transform = e,
                this.visualElement.rebaseTargetBox(!0, this.visualElement.getBoundingBoxWithoutTransforms())
            }
            ,
            t.prototype.resolveDragConstraints = function() {
                ...
                this.constraints && !this.hasMutatedConstraints && Ht((function(e) {
            ...
            t.prototype.resolveRefConstraints = function(t, e) {
                var n = this.props
                  ...
                  , o = e.current;
                Object(a.a)(null !== o, "If `dragConstraints` is set as a React ref, that ref must be passed to another component's `ref` prop."),
            ...
            t.prototype.updateAxis = function(t, e, n) {
                if (Pn(t, this.props.drag, this.currentDirection))
                    return this.getAxisMotionValue(t) ? this.updateAxisMotionValue(t, n) : this.updateVisualElementAxis(t, e)
            }
            ,
            ...
            t.prototype.updateVisualElementAxis = function(t, e) {
                var n, r = this.props.dragElastic, i = this.visualElement.box[t], o = i.max - i.min, a = this.cursorProgress[t], s = function(t, e, n, r, i) {
                    var o = t - e * n;
                    return r ? jn(o, r, i) : o
                }(an(e).point[t], o, a, null === (n = this.constraints) || void 0 === n ? void 0 : n[t], r);
            ...
            t.prototype.mount = function(t) {
                var e = this
                  , n = fn(t.getInstance(), "pointerdown", (function(t) {
                    var n = e.props
                      , r = n.drag
                      , i = n.dragListener;
                  ...
                  , o = t.prevSnapshot;
                return (null === o || void 0 === o ? void 0 : o.isDragging) && this.start(wn, {
        ...
        var Ln = function(t, e) {
            return !!e && (t === e || Ln(t, e.parentElement))
        }
        ...
        function Fn(t, e) {
            !function(t, e) {
                ...
                pn(e, "pointerdown", a && function(t) {
                    s.current = new hn(t,l,{
            ...
            function(t, e) {
                ...
                f.current = function(t, r) {
                    ...
                    c.current && o) {
                        ...
                        var s = Ke(!0);
                        s && (s(),
                        Ln(o, t.target) ? null === n || void 0 === n || n(t, r) : null === i || void 0 === i || i(t, r))
                    }
                }
                ,
                pn(e, "pointerdown", s ? function(t, n) {
                    d(),
                    l.current = Object(o.v)(fn(window, "pointerup", (function(t, e) {
                        var n;
                        return null === (n = f.current) || void 0 === n ? void 0 : n.call(f, t, e)
                    }
                    )), fn(window, "pointercancel", (function(t, e) {
                        var n;
                        return null === (n = f.current) || void 0 === n ? void 0 : n.call(f, t, e)
                    }
                    ))),
                    e.getInstance() && !c.current && (c.current = !0,
            ...
            function(t, e) {
                var n = t.whileHover
                  ...
                  , i = t.onHoverEnd;
                n && q(e, n, Dn),
                pn(e, "pointerenter", Un((function(t, i) {
                    null === r || void 0 === r || r(t, i),
                    n && K(e, Dn)
                }
                ))),
                pn(e, "pointerleave", Un((function(t, r) {
        ...
        var In = ["onPan", "onPanStart", "onPanEnd", "onPanSessionStart", "onTap", "onTapStart", "onTapCancel", "whileTap", "whileHover", "onHoverStart", "onHoverEnd"]
          , Hn = An((function(t) {
            var e = t.visualElement;
          ...
          , Xn = function() {
            ...
            t.prototype.set = function(t) {
                return Object(a.a)(this.hasMounted, "controls.set() should only be called after a component has mounted. Consider calling within a useEffect hook."),
          ...
          , zn = An((function(t) {
            ...
            Object(u.useEffect)((function() {
                a ? !l.current || !e || "boolean" === typeof e || e instanceof Xn || Z(i, e) : (!l.current && n && Z(i, n, {
                    custom: d
                }).then(s),
                l.current = !0),
                a && (l.current = !1)
        ...
        var Zn = {
            ...
            Component: An((function(t) {
                ...
                return function(t, e, n) {
                    ...
                    Object(u.useEffect)((function() {
                        var a, s, u = {}, c = Wn(e), l = Wn(e, !0);
                        for (var d in c) {
                            var f = i.current && (!t.hasValue(d) || t.getValue(d).get() !== l[d])
                              , p = null !== l[d]
                              , h = (a = o.current[d],
                            void 0 !== (s = l[d]) && (Array.isArray(a) && Array.isArray(s) ? !function(t, e) {
                                if (null === e)
                                    return !1;
                                var n = e.length;
                                if (n !== t.length)
                        ...
                        Object.keys(u).length && Z(t, Object(r.a)(Object(r.a)({}, u), {
          ...
          , _n = {
            ...
            Component: An((function(t) {
                var e = t.animate
                  ...
                  , r = void 0 === n || n;
                return function(t, e, n, r) {
                    var i, o = Gn(n), a = ye(), s = null === (i = a.parent) || void 0 === i ? void 0 : i.isMounted, c = Object(u.useRef)(!1);
                    Object(u.useEffect)((function() {
                        var n, i, u = !1;
                        r ? (u = !!s,
                        o = Gn(a.animate)) : u = c.current || (n = Gn(e),
                        i = o,
                        n.join(",") !== i.join(",")),
                        u && Z(t, o),
                        c.current = !0
          ...
          , qn = {
            ...
            getComponent: function(t) {
                return Zn.shouldRender(t) ? Zn.Component : _n.shouldRender(t) ? _n.Component : $n.shouldRender(t) ? $n.Component : void 0
            }
        };
        var Kn = function(t) {
            function e() {
                ...
                e.animate = function(t, n, i) {
                    ...
                    var p = Qn(n = o || n, t = a || t)
                      , h = Ht((function(r) {
                        ...
                        if (!d.isTargetBoxLocked)
                            return void 0 === s ? p ? e.animateAxis(r, t[r], n[r], c) : d.setAxisTarget(r, t[r].min, t[r].max) : void (s === Ae.Hide ? d.hide() : d.show())
                    }
                    ));
                    return d.render(),
                    Promise.all(h).then((function() {
                        ...
                        d.isPresent ? d.presence = Pe.Present : e.safeToRemove()
                    }
                    ))
                }
                ,
            ...
            e.prototype.componentDidMount = function() {
                ...
                e.updateConfig(Object(r.a)(Object(r.a)({}, e.config), {
            ...
            e.prototype.animateAxis = function(t, e, n, r) {
                var i, a, s = void 0 === r ? {} : r, u = s.transition, c = s.crossfadeOpacity;
                null === (a = (i = this.stopAxisAnimation)[t]) || void 0 === a || a.call(i);
                var l, d = this.props.visualElement, f = this.frameTarget[t], p = d.axisProgress[t];
                p.clearListeners(),
                p.set(0),
                p.set(0),
                c && (l = this.createCrossfadeAnimation(c),
                d.show());
                var h = function() {
                    var r = p.get() / 1e3;
                    !function(t, e, n, r) {
                    ...
                    d.setAxisTarget(t, f.min, f.max),
                    null === l || void 0 === l || l(r)
                };
                h(),
                d.updateLayoutDelta();
                var v = p.onChange(h)
                  , m = S("x" === t ? "layoutX" : "layoutY", p, 1e3, u || this.props.transition || er).then(v);
            ...
            e.prototype.createCrossfadeAnimation = function(t) {
                ...
                return function(n) {
                    e.set(rr(Object(o.u)(0, 1, n))),
                    t.set(ir(Object(o.u)(1, 0, n)))
                }
            }
            ,
        ...
        function Jn(t) {
            ...
            return Object(u.createElement)(Kn, Object(r.a)({}, t, {
                safeToRemove: e
            }))
        }
        function Qn(t, e) {
          ...
          , ar = function(t) {
            ...
            e.prototype.getSnapshotBeforeUpdate = function() {
                var t = this.props
                  , e = t.syncLayout
                  , n = t.visualElement;
                return De(e) ? e.syncUpdate() : (n.snapshotBoundingBox(),
                e.add(n)),
                null
            }
            ,
        ...
        function sr(t) {
            var e = Object(u.useContext)(Ue);
            return c.a.createElement(ar, Object(r.a)({}, t, {
                syncLayout: e
            }))
        }
        var ur = {
          ...
          , lr = {
            useVisualElement: function(t, e, n, i) {
                ...
                return a.isPresenceRoot = !o || o.presenceId !== l,
                Object(u.useEffect)((function() {
            ...
            render: function(t, e, n) {
                ...
                var o = ve(t) ? function(t) {
                    ...
                    return n && (i.draggable = !1,
                    i.style.userSelect = "none",
                    i.style.touchAction = !0 === n ? "none" : "pan-" + ("x" === n ? "y" : "x")),
                    i
                }(n, e);
        ...
        function dr(t) {
            var e = Object(r.a)(Object(r.a)({}, lr), {
                defaultFeatures: t
            });
            var n = new Map;
            return new Proxy({
                ...
                get: function(t, r) {
                    return "custom" === r ? t.custom : (n.has(r) || n.set(r, Ze(r, e)),
                    n.get(r))
                }
            })
        }
        ...
        function hr(t, e) {
            var n, r, i, o = {}, a = e && e.lead, s = null === a || void 0 === a ? void 0 : a.presence;
            return e && t === a ? t.presence === Pe.Entering ? o.originBox = e.getFollowOrigin() : t.presence === Pe.Exiting && (o.targetBox = e.getFollowTarget()) : e && t === e.follow && (o.transition = e.getLeadTransition(),
            s === Pe.Entering ? o.targetBox = e.getLeadTarget() : s === Pe.Exiting && (o.originBox = e.getLeadOrigin())),
        ...
        var vr = function() {
            ...
            t.prototype.updateSnapshot = function() {
                if (this.lead) {
                    ...
                    e && e.isDragging && (t.isDragging = !0,
                    t.cursorProgress = e.cursorProgress),
                    this.snapshot = t
                }
            }
            ,
        ...
        !function(t) {
            ...
            e.prototype.scheduleUpdate = function(t) {
                void 0 === t && (t = !1),
                !t && this.updateScheduled || (this.updateScheduled = !0,
                this.children.forEach((function(t) {
                ...
                !t && this.renderScheduled || (this.renderScheduled = !0,
                this.forceUpdate()))
            }
            ,
            ...
            e.prototype.getStack = function(t) {
                if (void 0 !== t)
                    return !this.stacks.has(t) && this.stacks.set(t, new vr),
                    this.stacks.get(t)
            }
            ,
            e.prototype.render = function() {
        ...
        if ("undefined" !== typeof window)
            if (window.matchMedia) {
                var yr = window.matchMedia("(prefers-reduced-motion)")
                  , br = function() {
                    return gr.set(yr.matches)
                };
                yr.addListener(br),
                br()
            } else
