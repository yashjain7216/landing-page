    ...
    elyg: function(t, e, r) {
        ...
        function S(t, e) {
            var r = new URL(t,"http://n")
              , n = "string" === typeof e ? e : (0,
            f.formatWithValidation)(e);
            try {
                var o = new URL(n,r);
                return o.pathname = (0,
                c.normalizePathTrailingSlash)(o.pathname),
        ...
        var O = function() {
            function t(e, r, n, o) {
                ...
                this.query = r,
                this.asPath = (0,
                h.isDynamicRoute)(e) && __NEXT_DATA__.autoExport ? e : n,
                this.basePath = "",
                this.sub = m,
                this.clc = null,
                this._wrapApp = d,
            ...
            return u(t, [{
                ...
                value: function() {
                    var e = a(o.mark((function e(r, n, a, i) {
                        var u, s, l, g, m, w, S, P, k, E, R, O, L, C, j, A, I, T;
                        return o.wrap((function(e) {
                            for (; ; )
                                ...
                                case 21:
                                    ...
                                    w = (m = g).pathname,
                                    S = m.searchParams,
                                    (g = this._resolveHref(g, s)).pathname !== w && (w = g.pathname,
                                    n = (0,
                                    f.formatWithValidation)(g)),
                                    P = (0,
                                    d.searchParamsToUrlQuery)(S),
                                    w = w ? (0,
                                    c.removePathTrailingSlash)(_(w)) : w,
                                    this.urlIsNew(u) || (r = "replaceState"),
                                    k = (0,
                                    c.removePathTrailingSlash)(w),
                                    E = i.shallow,
                                    R = void 0 !== E && E,
                                    O = _(O = a),
                                    !(0,
                                    ...
                                    y.getRouteRegex)(k),
                                    A = (0,
                                    v.getRouteMatcher)(j)(C)) {
                                        e.next = 46;
                                        break
                                    }
                                    if (!(Object.keys(j.groups).filter((function(t) {
                                        return !P[t]
                                    }
                                    )).length > 0)) {
                                        e.next = 44;
                                    ...
                                    throw new Error("The provided `as` value (".concat(C, ") is incompatible with the `href` value (").concat(k, "). ") + "Read more: https://err.sh/vercel/next.js/incompatible-href-as");
                                case 44:
                                    e.next = 47;
                                    break;
                                case 46:
                                    Object.assign(P, A);
                                case 47:
                                    return t.events.emit("routeChangeStart", a),
                                    e.prev = 48,
                                    e.next = 51,
                                ...
                                case 51:
                                    ...
                                    this.changeState(r, n, a, i),
                                    e.next = 58,
                                    this.set(k, w, P, u, I).catch((function(t) {
                                        if (!t.cancelled)
                                            throw t;
                                        T = T || t
                                    }
                                ...
                                case 58:
                                    ...
                                    throw t.events.emit("routeChangeError", T, u),
                                    T;
                                case 61:
                                    return t.events.emit("routeChangeComplete", a),
                                    e.abrupt("return", !0);
                                case 66:
                                    if (e.prev = 66,
                                    e.t0 = e.catch(48),
                        ...
                        return o.wrap((function(e) {
                            for (; ; )
                                ...
                                case 26:
                                    return e.prev = 26,
                                    e.t1 = e.catch(6),
                                    e.abrupt("return", this.handleRouteInfoError(e.t1, n, a, i, !0));
                                case 29:
                                case "end":
                                    return e.stop()
                                }
                ...
                value: function() {
                    var t = a(o.mark((function t(e, r, n, a) {
                        var i, u, c, s, l, h, p, d, v = this, y = arguments;
                        return o.wrap((function(t) {
                            for (; ; )
                                switch (t.prev = t.next) {
                                case 0:
                                    if (i = y.length > 4 && void 0 !== y[4] && y[4],
                                    t.prev = 1,
                                    u = this.components[e],
                                    !i || !u || this.route !== e) {
                                        t.next = 5;
                                ...
                                case 12:
                                    ...
                                    break;
                                case 18:
                                    return (l || h) && (p = this.pageLoader.getDataHref((0,
                                    f.formatWithValidation)({
                                        pathname: r,
                                        query: n
                                    }), _(a), l)),
                ...
                value: function(t, e) {
                    var r = t.pathname
                      , n = (0,
                    s.denormalizePagePath)(_(r));
                    return "/404" === n || "/_error" === n || e.includes(n) || e.some((function(e) {
                        if ((0,
                        h.isDynamicRoute)(e) && (0,
                        y.getRouteRegex)(e).re.test(n))
                            return t.pathname = e,
                            !0
                    }
                    )),
                    ...
                    var t = a(o.mark((function t(e) {
                        ...
                        return o.wrap((function(t) {
                            for (; ; )
                                switch (t.prev = t.next) {
                                case 0:
                                    return r = l.length > 1 && void 0 !== l[1] ? l[1] : e,
                                ...
                                case 6:
                                    u = t.sent,
                                    (a = this._resolveHref(a, u)).pathname !== i && (i = a.pathname,
                                    e = (0,
                                    f.formatWithValidation)(a)),
                                    t.next = 11;
                                    break;
                                case 11:
                                    return s = (0,
                                    ...
                                    t.next = 14,
                                    Promise.all([this.pageLoader.prefetchData(e, r), this.pageLoader[n.priority ? "loadPage" : "prefetch"](s)]);
                                case 14:
                                case "end":
                                    return t.stop()
                                }
                        ...
                        return o.wrap((function(t) {
                            for (; ; )
                                ...
                                case 4:
                                    ...
                                    i;
                                case 9:
                                    return n === this.clc && (this.clc = null),
                                    t.abrupt("return", a);
                                case 11:
                                case "end":
                                    return t.stop()
                ...
                value: function(t) {
                    ...
                    return this.sdc[r] ? Promise.resolve(this.sdc[r]) : R(t, this.isSsr).then((function(t) {
                        return e.sdc[r] = t,
                        t
                    }
                    ))
                ...
                value: function(e) {
                    this.clc && (t.events.emit("routeChangeError", m(), e),
                    this.clc(),
                    this.clc = null)
                }
            }, {
